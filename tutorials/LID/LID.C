...
class tutorialLIDcavity: public unsteadyNS
{
    public:
        explicit tutorialLIDcavity(int argc, char* argv[])
            :
...
{
    // Construct the tutorialLIDcavity object
    tutorialLIDcavity example(argc, argv);
...
/* // Create a list with number of modes for which the projection needs to be performed
   ...
   // example.onlineSolveRead("./ITHACAoutput/OfflineFull/");
